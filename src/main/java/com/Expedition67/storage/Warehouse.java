...
public class Warehouse {
    ...
    private void loadCard() {
        ...
        cardFactory.put(CardName.CELESTIAL_SINGULARITY, new Card(CardName.CELESTIAL_SINGULARITY, 3, true, -1, new SingularityAbility( CardAbility.CardType.DEF), Card.CardTier.NORMAL, "Gain 35 Block. The next card played costs 0 AP."));
