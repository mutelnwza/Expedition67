...
public class Warehouse {
    ...
    private void loadCard() {
        // Void
        cardFactory.put(CardName.VOID, new Card(CardName.VOID, 1, new VoidCard(CardAbility.CardType.VOID), Card.CardTier.DEBUFF, "GET VOID"));

        // Attack
        cardFactory.put(CardName.SOUL_FLICKER, new Card(CardName.SOUL_FLICKER, 0, new DamageAbility(6, CardAbility.CardType.ATK), Card.CardTier.NORMAL, "Deal 6 damage. A faint spark of soul energy."));
        cardFactory.put(CardName.REMNANT_HIT, new Card(CardName.REMNANT_HIT, 1, new DamageAbility(12, CardAbility.CardType.ATK), Card.CardTier.NORMAL, "Deal 12 damage. A precise strike fueled by lingering soul fragments."));
        cardFactory.put(CardName.ECHOING_STRIKE, new Card(CardName.ECHOING_STRIKE, 2, new AoEDamageAbility(30, CardAbility.CardType.ATK), Card.CardTier.RARE, "Deal 30 damage to all enemies. A strong condensed of your spirit"));
        ...
        // Defense
        cardFactory.put(CardName.SPECTRAL_VEIL, new Card(CardName.SPECTRAL_VEIL, 1, new ShieldAbility(10, CardAbility.CardType.DEF), Card.CardTier.NORMAL, "Gain 10 Block. A thin veil of shattered souls to absorb impacts."));
        cardFactory.put(CardName.SOUL_AEGIS, new Card(CardName.SOUL_AEGIS, 2, new ShieldHealAbility(20, 10,CardAbility.CardType.DEF), Card.CardTier.NORMAL, "Gain 20 Block and heal 10 HP. Converts kinetic force into life energy."));
        ...
        cardFactory.put(CardName.EVENT_HORIZON, new Card(CardName.EVENT_HORIZON, 4,  new ShieldAbility(70, CardAbility.CardType.DEF), Card.CardTier.RARE, "Gain 70 Block. Incoming strikes vanish into the void."));
        ...
        cardFactory.put(CardName.SOVEREIGNS_OVERDRIVE, new Card(CardName.SOVEREIGNS_OVERDRIVE, 0, new OverdriveAbility(1, 15, 1, CardAbility.CardType.BUFF), Card.CardTier.NORMAL, "Lose 15 HP. All your attacks this turn have a 100% Critical Rate."));
        ...
        cardFactory.put(CardName.ETERNAL_SOUL_REBIRTH, new Card(CardName.ETERNAL_SOUL_REBIRTH, 3, new RebirthAbility(10,30,28 ,CardAbility.CardType.HEAL), Card.CardTier.RARE, "Heal 28 HP and gain 10 Block. If HP < 20%, gain 30 Block."));
    }
